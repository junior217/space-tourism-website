...
export default function SpacePort(){
    const SpacePort = spaceTourismData[0].technology[2]
    ...
    return (
        <div className=" ml-[20%] mr-0 my-5 grid grid-cols-[1fr_auto]">
            <div className="px-2 w-130 flex flex-col justify-center gap-2">
                ...
                <h1 className="uppercase text-3xl text-slate-200 font-light mb-3">{SpacePort.name}</h1>
                <p className="text-slate-300 text-lg">{SpacePort.description}</p>
            </div>
